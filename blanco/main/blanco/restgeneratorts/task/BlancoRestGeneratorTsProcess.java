...
/**
 * Process [BlancoRestGeneratorTsProcess] interface.
 *
 * Inherit this interface and create a [BlancoRestGeneratorTsProcessclass in the [blanco.restgeneratorts.task] package to implement the actual batch processing.<br>
 */
